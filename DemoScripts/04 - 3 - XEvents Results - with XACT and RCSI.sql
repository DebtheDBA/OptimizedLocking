/*
Read the file with the results for optimized locking with RCSI

Notice how much smaller the files are. We're not even seeing locks acquired and released.
Also, notice how there's no lock escalation for the larger update.
*/

-- read the current file
-- original file created by the trace: C:\XE_Logs\LockTracking*.xel
DECLARE @eventFileTarget NVARCHAR(400) = 'C:\XE_Logs\LockTracking_with_XACT_RCSI.xel.bckp'
